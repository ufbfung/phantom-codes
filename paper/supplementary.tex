% Phantom Codes — supplementary materials master file.
%
% Mirrors paper/main.tex's preamble (same biblatex setup, same packages)
% so prose conventions and citation rendering are identical between the
% main manuscript and the supplement. The main difference: this file
% \input{}'s build/supp_sections/*.tex (one per S1-Sn section) instead
% of build/sections/*.tex.
%
% Build:
%     cd paper && make supp
%
% Output: paper/build/supplementary.pdf
%
% Editing model:
...
\input{build/supp_sections/S3_reproducibility}
