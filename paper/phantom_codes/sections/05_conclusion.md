...
Two deployment prescriptions emerge. **Zero-shot LLM prompting is
unsafe for clinical concept normalization**, since every
...
grounded configurations, **cost-per-correct rather than accuracy
...
metric. The deployment frontier consists of **GPT-4o-mini
constrained** (94.2% top-1, \$0.0003 per correct, the cheapest
configuration at ≥94% accuracy) and **Claude Haiku 4.5
