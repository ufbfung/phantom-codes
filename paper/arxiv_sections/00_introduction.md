...
Clinical concept normalization — mapping unstructured mentions of
diagnoses, medications, and labs to identifiers in controlled
vocabularies such as ICD-10-CM — sits at the foundation of
...
discharge summaries [@Mullenbach2018] and transformer-based
extensions adapting domain-pretrained encoders such as PubMedBERT
[@Gu2021; @Huang2022] to the multi-label setting. Two practical
constraints shape how such classifiers can be built and shared in
the current regulatory landscape:

1. **PhysioNet's responsible-LLM-use policy** [@PhysioNet2025],
...
2. **Trained-model weights derived from credentialed corpora are
...
for **PubMedBERT-base** [@Gu2021] on MIMIC-IV-FHIR v2.1
[@Bennett2024; @Bennett2023; @Johnson2023] restricted to ICD-10-CM
codes in the CMS ACCESS Model FHIR Implementation Guide [@CMS2026].
...
persistence runs on **consumer Apple Silicon hardware** (M1
...
out-of-distribution inputs [@FungPhantomCodes2026]. That paper is
